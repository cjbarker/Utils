...
BREW_GUI=(google-chrome java vlc iterm2 macvim virtualbox spotify skype android-studio eclipse-java slack visual-studio-code dash gimp brave flux spectacle github-desktop google-earth-pro android-sdk lastpass handbrake easyfind keybase balsamiq-mockups)
